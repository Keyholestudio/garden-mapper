"""
Garden Mapper — Missed Tier 1 Batch (5 stickers)
Lavender, Saskatoon Berry, Blueberry, Phlox, Hostas
All use the PLANTS prompt template (Rob's wording — do not modify).
...
PLANTS = [
    {
        "id": "shrub-lavender_lavender_M_CA-US-FR-GB-AU",
        "name": "English Lavender", "type": "perennial herb shrub", "size": 256,
    ...
    {
        "id": "shrub-flowering_saskatoon_M_CA-US",
        "name": "Saskatoon Berry", "type": "fruiting deciduous shrub", "size": 256,
    ...
    {
        "id": "shrub-flowering_blueberry_M_CA-US-FR-GB-AU",
        "name": "Blueberry Bush", "type": "compact fruiting shrub", "size": 256,
    ...
    {
        "id": "flower-cluster_phlox_S_CA-US-FR-GB-AU",
        "name": "Phlox", "type": "low spreading perennial flower", "size": 160,
    ...
    {
        "id": "ground-cover_hostas_M_CA-US-FR-GB-AU",
        "name": "Hostas", "type": "shade perennial with large leaves", "size": 256,
...
def main():
    p("=" * 60)
    p(f"Garden Mapper -- Missed Tier 1 Batch ({len(PLANTS)} stickers)")
    ...
    for i, plant in enumerate(PLANTS):
        p(f"[{i+1}/{len(PLANTS)}] {plant['name']} ({plant['id']})")
