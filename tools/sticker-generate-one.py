...
PLANT_LOOKUP = {
    ...
    "water lily":        ("aquatic_water-lily",            "M",  256, "Aquatic",     "plant", "dark outline #0A1A0A, flat solid cyan background (#00FFFF)", "Water lily pads sitting naturally in a pond. No water. Top-down view. No stems visible. Correct proportions."),
    # ── Daisy-type Flowers ───────────────────────────────────────────────────────────
