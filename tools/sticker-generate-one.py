...
PLANT_LOOKUP = {
    ...
    "verbena bonariensis":("flower-spike_verbena-bonariensis","L", 384, "Perennial",     "plant", "vivid purple #7B35C8, deep violet #5A1A9A, pale lilac #C4A8E0, dark green wiry stems #2A4A1A, mid-green #4A7C2F, dark outline #0A0A1A", "Tall airy branching wiry stems topped with tight flat clusters of tiny vivid purple flowers. Minimal foliage — mostly bare stems. Very open, see-through plant silhouette. Correct proportions. No roots."),
