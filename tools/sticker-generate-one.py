...
PLANT_LOOKUP = {
    ...
    "fountain":          ("water-feature_fountain",     "L",  384, "Water Feature",  "plant",     "cool grey stone #8A9A9A, pale marble white #F0EEE8, water blue #5A9AC8, pale aqua foam #A8D8F0, dark outline #1A2A3A", "Aerial top-down view of circular garden water fountain, no tier, decorative cement edging around the basin rim, central spout, water ripples radiating outward. No birds. Correct proportions."),
