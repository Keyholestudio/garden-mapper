...
PLANT_LOOKUP = {
    ...
    "eucalyptus":        ("tree-evergreen_eucalyptus",   "XL", 512, "Evergreen Tree", "deciduous", "silver-blue green #7A9AB0, pale silver-green #A8C0B0, glaucous blue #6A8AA0, pale cream bark #D4C8A8, warm grey limbs #9A8A7A", "Natural open airy canopy of distinctive blue-grey sickle-shaped leaves with peeling bark. No trunk."),
    ...
    "italian cypress":   ("tree-conifer_italian-cypress", "XL", 512, "Coniferous Tree", "pine", "deep forest green #1A5C1A, mid-green #2E7A2E, dark outline #0A2010", "Very tall narrow columnar conifer with dense tight dark green foliage. Pencil-thin silhouette, extremely narrow."),
    ...
    "deutzia":           ("shrub-flowering_deutzia",      "S",  160, "Deciduous Shrub", "plant", "pure white #F8F8F0, pale pink #F5C8D8, bright green #5AB83A, warm brown arching stems #6B3A2A, dark outline #0A1A0A", "Compact arching shrub smothered in masses of small star-shaped white flowers along arching stems. Correct proportions. No roots."),
