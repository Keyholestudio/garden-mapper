...
PLANT_LOOKUP = {
    ...
    "lotus":             ("aquatic_lotus",              "L",  384, "Aquatic",      "plant", "vivid pink #E87090, pale pink #F5C0D0, golden yellow centre #FFD700, deep green round pads #1A6A2A, mid-green #3A8A3A, flat solid bright orange background (#FF6600)", "Sacred lotus flower with large round floating green pads and tall elegant vivid pink bowl-shaped flower above. Top-down view, no water, no stems visible. Correct proportions. No roots. IMPORTANT: The entire background must be a flat solid bright orange (#FF6600) colour — no gradients, no purple, no dark tones."),
    ...
    "water mint":        ("aquatic_water-mint",         "M",  256, "Aquatic",      "plant", "vivid lavender-mauve #9A78C8, mid-purple #7A58A8, bright green rounded leaves #3A8A3A, pale lavender florets #C8B0E8, flat solid magenta background (#FF00FF)", "Water mint with spreading bright green rounded toothed leaves and small vivid lavender-mauve rounded flower clusters at stem tips. Marginal pond herb. Correct proportions. No roots."),
