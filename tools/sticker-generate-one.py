...
PLANT_LOOKUP = {
    ...
    "water forget-me-not": ("aquatic_water-forget-me-not", "XS", 96, "Aquatic", "plant", "vivid sky-blue #3A8AD4, pale blue #A8C8E8, bright green oval leaves #4A8A3A, yellow eye #FFE870, flat solid cyan background (#00FFFF)", "Low creeping marginal plant with small vivid sky-blue forget-me-not flowers with yellow centres above bright green oval leaves. Correct proportions. No roots."),
    ...
    "agave":             ("plant-architectural_agave",  "L",  384, "Architectural", "plant", "blue-grey green #5A8090, pale silver-blue #8AAFB0, deep grey-green #3A6070, sharp spine tips #C8C0B0, flat solid cyan background (#00FFFF)", "Agave succulent. Thick rigid blue-grey pointed leaves in a radial rosette. Sharp spines at tips. Slight overhead angle. Correct proportions. No roots."),
    "yucca":             ("plant-architectural_yucca",  "L",  384, "Architectural", "plant", "deep green #1A6A2A, mid-green #3A8A3A, sharp cream-white tips #F0EEE0, pale green #8AC890, flat solid cyan background (#00FFFF)", "Yucca plant. Stiff upright sword-shaped leaves with cream-white tips radiating from a central base. Slight overhead angle. Correct proportions. No roots."),
