...
PLANT_LOOKUP = {
    ...
    "pussy willow":      ("tree-deciduous_pussy-willow",  "L",  384, "Deciduous Tree", "deciduous", "silver-grey catkins #C8C8C0, pale silver #D8D8D0, bright green oval leaves #5AB83A, mid-green #4A8A3A, warm brown limbs #6B3A2A", "Natural rounded shrubby canopy with masses of soft silver-grey fuzzy catkins on bare stems above emerging bright green leaves. No trunk."),
