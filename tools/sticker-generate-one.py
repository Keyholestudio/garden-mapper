...
PLANT_LOOKUP = {
    ...
    "male fern":         ("plant-fern_male-fern",         "L",  384, "Fern / Groundcover", "plant", "deep forest green #2A6A3A, mid green #4A8A5A, bright green #5AB83A, pale green undersides #8ABF6A, dark outline #0A1A0A", "Robust upright vase of large pinnate fronds, each frond broadly lance-shaped with rounded lobed pinnules, fronds arching outward from the centre in a semi-evergreen clump."),
    "ostrich fern":      ("plant-fern_ostrich-fern",      "L",  384, "Fern / Groundcover", "plant", "vivid green #5AB83A, deep green #2A6A3A, bright lime-green #7AC83A, pale green #8ABF6A, dark outline #0A1A0A", "Iconic vase-shaped fern with large broadly lance-shaped fronds that are wide in the middle and narrow at both ends, fronds spreading dramatically outward like a shuttlecock or ostrich plume."),
    "japanese painted fern": ("plant-fern_japanese-painted-fern", "M", 256, "Fern / Groundcover", "plant", "silver-grey #A8B8B0, pewter-green #7A9A8A, burgundy-red midrib #8B2A2A, pale silver fronds #C8D8D0, dark outline #0A1818", "Arching spreading fern with distinctive silver-grey fronds marked with a deep burgundy-red midrib, fronds are pinnate and elegantly arched, giving a painted metallic appearance."),
    ...
    "perennial leek":        ("vegetable-perennial_perennial-leek", "M", 256, "Perennial Vegetable", "plant", "blue-green strap #6A9A7A, mid green #4A8A5A, purple-pink allium ball #C87890, pale strap #8AAFA0, dark outline #0A1A10", "Upright blue-green strap-leaved plant with a decorative round purple-pink allium flower head at top."),
    # Fruit - Stone
