...
PLANT_LOOKUP = {
    ...
    "fennel":            ("herb-culinary_fennel",         "XL", 512, "Herb", "plant", "bright yellow-green #C8E04A, mid-green #6A9A2A, soft olive #8FA040, golden yellow #E8C050, dark stem #3A5A10", "Small bush. Natural full grown plant. Tall feathery plant with finely divided thread-like fronds and flat-topped golden-yellow flower umbels, stems at bottom and leafy florals at the top."),
