...
PLANT_LOOKUP = {
    ...
    "romanesco":             ("vegetable-brassica_romanesco",      "M",  256, "Brassica",        "plant",   "vivid yellow-green #8ABF2A, mid green #5A8A3A, pale lime-green #C8D870, geometric spirals #6A9A2A, dark outline #0A1A0A", "Simplified 3d shape, surrounded by romanesco leaves. Striking fractal spiral head of vivid lime-green romanesco with perfect pointed logarithmic spirals radiating from centre."),
