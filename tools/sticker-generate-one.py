...
PLANT_LOOKUP = {
    ...
    "italian cypress":   ("tree-conifer_italian-cypress", "XL", 512, "Coniferous Tree", "pine", "deep forest green #1A5C1A, mid-green #2E7A2E, dark outline #0A2010", "Extremely tall and pencil-thin columnar conifer — width is only 1/8 of its height. Like a green spike or flame shape. Dense smooth dark green foliage hugging a dead-straight vertical axis. No spreading branches, no irregular edges. Classic Italian Cypress Mediterranean silhouette."),
