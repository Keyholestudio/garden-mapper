...
PLANT_LOOKUP = {
    ...
    # Vegetables - Root
    "celeriac":              ("vegetable-root_celeriac",          "M",  256, "Root Vegetable",   "rootveg", "pale cream-tan bulb #D4C890, mid green tops #4A8A3A, celery-green #6AAF5A, dark outline #0A1A0A", "Rough knobbly round bulb peeking from soil line with upright celery-like green stalks above."),
    ...
    "salsify":               ("vegetable-root_salsify",           "M",  256, "Root Vegetable",   "rootveg", "pale cream root #F0E8C8, mid green strap tops #4A8A3A, purple flower #7B35C8, dark outline #0A1A0A", "Long slender pale root peeking from soil line with upright grass-like strap leaves and purple flower."),
    ...
    "hamburg parsley":       ("vegetable-root_hamburg-parsley",   "M",  256, "Root Vegetable",   "rootveg", "pale cream root #F0E8C0, mid green #4A8A3A, bright green parsley #5AB83A, dark outline #0A1A0A", "Thick white parsnip-like root peeking from soil with curly bright green parsley-like tops above."),
    "sweet potato":          ("vegetable-root_sweet-potato",      "M",  256, "Root Vegetable",   "rootveg", "warm orange #E87820, deep orange #C45A10, bright green vines #5AB83A, heart-shaped leaves #4A8A3A, dark outline #0A1A0A", "Round orange sweet potato peeking from soil line with spreading heart-shaped vine leaves above."),
