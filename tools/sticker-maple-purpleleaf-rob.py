"""Maple Purple Leaf — Rob's edited prompt"""
...
FILENAME = "tree-deciduous_maple_XXL_purple-leaf-rob.png"
...
PROMPT = (
    ...
    "Canvas: 512px square.\n"
    "Colours: Spring/summer purple-leaf cultivar — deep purple #6A1B9A, purple #7B1FA2, dark purple-green #4A148C, "
    "flat chroma-key green background (#00FF00)\n"
    "Shape: Natural leafy canopy Rich purple spring/summer foliage. NOT fall colours."
)
