"""Regen Oak Tree v3 — Rob's exact prompt, no olive"""
import json, base64, time, os, subprocess, shutil, tempfile
...
Canvas: 512px square.
Colours: mid-green #4A8C3A, kelly green, dark green accents, dark outline #0A1A0A, flat chroma-key green background (#00FF00)
...
patched_path = os.path.join(tempfile.gettempdir(), "pipeline_oak3.py")
