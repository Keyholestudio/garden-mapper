"""Maple Dark Green v3 — Rob's edited prompt"""
...
PROMPT = (
    ...
    "Subject: Maple Tree canopy, large broad deciduous tree. NO TRUNK. Canopy only. Small leaves.\n"
    "Canvas: 512px square.\n"
    "Colours: Deep dark green foliage (Norway Maple / Crimson King spring/summer) — "
    "dark green #2E7D32, very dark #1B5E20, mid-green #388E3C. flat chroma-key green background (#00FF00)\n"
