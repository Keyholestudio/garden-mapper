...
export default function GardenEditor() {
  ...
  // ── Window resize ─────────────────────────────────────────────────────────
  // GardenCanvas has a ResizeObserver that handles most resize cases.
  ...
  const DECOR_CATALOG = {
    ...
    'decor-gazebo-square':{ key: 'decor_gazebo-square_XL_CA-US-FR-GB-AU', label: 'Gazebos', family: 'Decor', size: 'XXL', decorGroup: 'gazebos', src: '/stickers/decor_gazebo-square_XL_CA-US-FR-GB-AU.png' },
    'decor-gazebo-oct':   { key: 'decor_gazebo-oct_XL_CA-US-FR-GB-AU',   label: 'Gazebos', family: 'Decor', size: 'XXL', decorGroup: 'gazebos', src: '/stickers/decor_gazebo-oct_XL_CA-US-FR-GB-AU.png'   },
    'decor-gazebo-large': { key: 'decor_gazebo-large_XL_CA-US-FR-GB-AU',  label: 'Gazebos', family: 'Decor', size: 'XXL', decorGroup: 'gazebos', src: '/stickers/decor_gazebo-large_XL_CA-US-FR-GB-AU.png'  },
    'decor-lounge-modern':{ key: 'decor_lounge-modern_XL_CA-US-FR-GB-AU', label: 'Seating', family: 'Decor', size: 'XL',  decorGroup: 'seating', src: '/stickers/decor_lounge-modern_XL_CA-US-FR-GB-AU.png' },
    'decor-lounge-wood':  { key: 'decor_lounge-wood_XL_CA-US-FR-GB-AU',  label: 'Seating', family: 'Decor', size: 'XL',  decorGroup: 'seating', src: '/stickers/decor_lounge-wood_XL_CA-US-FR-GB-AU.png'  },
    'decor-table-pine':    { key: 'decor_table-pine_XXL_CA-US-FR-GB-AU',    label: 'Seating', family: 'Decor', size: 'XXL', decorGroup: 'seating', src: '/stickers/decor_table-pine_XXL_CA-US-FR-GB-AU.png'    },
    'decor-table-stained':  { key: 'decor_table-stained_XXL_CA-US-FR-GB-AU',  label: 'Seating', family: 'Decor', size: 'XXL', decorGroup: 'seating', src: '/stickers/decor_table-stained_XXL_CA-US-FR-GB-AU.png'  },
    'decor-table-enameled': { key: 'decor_table-enameled_XXL_CA-US-FR-GB-AU', label: 'Seating', family: 'Decor', size: 'XXL', decorGroup: 'seating', src: '/stickers/decor_table-enameled_XXL_CA-US-FR-GB-AU.png' },
    'decor-table-bronzed':  { key: 'decor_table-bronzed_XXL_CA-US-FR-GB-AU',  label: 'Seating', family: 'Decor', size: 'XXL', decorGroup: 'seating', src: '/stickers/decor_table-bronzed_XXL_CA-US-FR-GB-AU.png'  },
    ...
    'decor-pot-red-round':        { key: 'decor_pot-red-round_S_CA-US-FR-GB-AU',        label: 'Flower Pots', family: 'Decor', size: 'S', decorGroup: 'pots', src: '/stickers/decor_pot-red-round_S_CA-US-FR-GB-AU.png'        },
    'decor-pot-terracotta-round':  { key: 'decor_pot-terracotta-round_M_CA-US-FR-GB-AU',  label: 'Flower Pots', family: 'Decor', size: 'M', decorGroup: 'pots', src: '/stickers/decor_pot-terracotta-round_M_CA-US-FR-GB-AU.png'  },
    ...
    'decor-stairs-stone':      { key: 'decor_stairs-stone_XL_CA-US-FR-GB-AU',      label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-stone_XL_CA-US-FR-GB-AU.png'      },
    'decor-stairs-wood':       { key: 'decor_stairs-wood_XL_CA-US-FR-GB-AU',       label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-wood_XL_CA-US-FR-GB-AU.png'       },
    'decor-stairs-wood-rail':  { key: 'decor_stairs-wood-rail_XL_CA-US-FR-GB-AU',  label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-wood-rail_XL_CA-US-FR-GB-AU.png'  },
    'decor-stairs-stone-rail': { key: 'decor_stairs-stone-rail_XL_CA-US-FR-GB-AU', label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-stone-rail_XL_CA-US-FR-GB-AU.png' },
    'decor-stairs-brick':      { key: 'decor_stairs-brick_XL_CA-US-FR-GB-AU',      label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-brick_XL_CA-US-FR-GB-AU.png'      },
    'decor-stairs-wood-stone': { key: 'decor_stairs-wood-stone_XL_CA-US-FR-GB-AU', label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-wood-stone_XL_CA-US-FR-GB-AU.png' },
    'decor-stairs-open-wood':  { key: 'decor_stairs-open-wood_XL_CA-US-FR-GB-AU',  label: 'Stairs', family: 'Decor', size: 'XL', decorGroup: 'stairs', src: '/stickers/decor_stairs-open-wood_XL_CA-US-FR-GB-AU.png'  },
