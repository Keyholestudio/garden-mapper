...
export const PATH_COLOURS    = ['#D7CCC8','#BCAAA4','#9E9E9E',
  '#TX:path-brick','#TX:path-brick-red']
...
export const DECOR_VARIANTS = {
  stairs: [
    ...
    { label: 'Sandstone Stairs',   subtitle: 'Sandstone Stairs',   size: 'M', colour: '#B06030', src: '/stickers/decor_stairs-wood-rail_M_CA-US-FR-GB-AU.png' },
