...
export const PLANT_VARIANTS = {
  ...
  // label = family value from usePlantCatalog.js — matches the subtitle shown for plants without a colour picker
  'tree-deciduous_maple': [
    { label: 'Deciduous Tree', name: 'Maple Tree',      colour: '#4CAF50', src: null },
  ...
  'flower-spike_iris': [
    { label: 'Perennial', name: 'Iris',          colour: '#7B35C8', src: null },
  ...
  'shrub-flowering_azalea': [
    { label: 'Shrub', name: 'Azalea',       colour: '#E84A2A', src: null },
  ...
  'flower-spike_hollyhock': [
    { label: 'Biennial', name: 'Hollyhock',       colour: '#E8407A', src: null },
  ...
  'flower-rose_peony': [
    { label: 'Perennial', name: 'Peony',       colour: '#E8407A', src: null },
  ...
  'flower-rose_rose': [
    { label: 'Shrub / Rose', name: 'Rose',             colour: '#C41230', src: null },
  ...
  'flower-rose_climbing-rose': [
    { label: 'Shrub / Rose', name: 'Climbing Rose',       colour: '#C41230', src: null },
  ...
  'herb-small_basil': [
    { label: 'Herb',   name: 'Basil',         colour: '#5AB83A', src: null },
  ...
  'flower-daisy_zinnia': [
    { label: 'Annual Flower', name: 'Zinnia',       colour: '#FF6B1A', src: null },
  ...
  'flower-daisy_dahlia': [
    { label: 'Bulb / Annual', name: 'Dahlia',        colour: '#C41270', src: null },
  ...
  'flower-daisy_geranium': [
    { label: 'Annual Flower', name: 'Geranium',              colour: '#D42B2B', src: null },
  ...
  'vegetable-leafy_lettuce': [
    { label: 'Vegetable',   name: 'Lettuce',               colour: '#66BB6A', src: null },
...
const GATE_VARIANT_LIST = [
  { label: 'White',    colour: '#F5F5F5', src: '/stickers/decor_gate-wood-white_XL_CA-US-FR-GB-AU.png' },
  { label: 'Cedar',    colour: '#8B5E3C', src: '/stickers/decor_gate-wood-cedar_XL_CA-US-FR-GB-AU.png' },
...
export const GATE_VARIANTS = {
  ...
  'decor_gate-wood-charcoal_XL_CA-US-FR-GB-AU': GATE_VARIANT_LIST,
  'decor_gate-wood-red_XL_CA-US-FR-GB-AU':      GATE_VARIANT_LIST,
  'decor_gate-wood-blue_XL_CA-US-FR-GB-AU':     GATE_VARIANT_LIST,
...
export const DECOR_VARIANTS = {
  stairs: [
    ...
    { label: 'Stone + Railings',  subtitle: 'Stone + Railings',  size: 'M', colour: '#A09080', src: '/stickers/decor_stairs-stone-rail_M_CA-US-FR-GB-AU.png' },
    { label: 'Brick Stairs',      subtitle: 'Brick Stairs',      size: 'M', colour: '#B84A28', src: '/stickers/decor_stairs-brick_M_CA-US-FR-GB-AU.png' },
    { label: 'Wood & Stone',      subtitle: 'Wood & Stone',      size: 'M', colour: '#B09870', src: '/stickers/decor_stairs-wood-stone_M_CA-US-FR-GB-AU.png' },
    { label: 'Open-Riser Wood',   subtitle: 'Open-Riser Wood',   size: 'M', colour: '#987040', src: '/stickers/decor_stairs-open-wood_M_CA-US-FR-GB-AU.png' },
  ],
  arches: [
